...
class RoomsTableViewController: UITableViewController {
    ...
    var demoRoomList: [String] = ["item1", "item2", "item3"]
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl?.addTarget(self, action: #selector(RoomsTableViewController.refresh(_:)), forControlEvents: UIControlEvents.ValueChanged)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.roomName.text = demoRoomList[indexPath.row]
        return cell
    }
    
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        currentTitle = demoRoomList[indexPath.row]
        self.performSegueWithIdentifier("showRoomConversation", sender: tableView)
    }
    
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if (segue.identifier == "showRoomConversation") {
